<template>
    <div id="utilizationinflowPie"></div>
</template>
<script setup name="utilizationinflowPie">
    ...
    const portName = ref([])
    let getData= () => {
		return flowApi.inflowRate().then((data) => {
            seriesData.value = data.outflowUsage
    ...
    let chartTop = () => {
        let Echarts = echarts.init(document.getElementById('utilizationinflowPie'))
