    ...
    <div class="content" v-if="isData" style="height: 400px;">
        ...
        <a-row :gutter="40" justify="space-between" class="contdiv">
            <a-col :span="24" class="leftcontent" >
                <div id="mysqlChart" style="height:280px;width:98%" ></div> 
            </a-col>
        </a-row>
    </div> 

</template>
<script setup name="mssqlChart">
    ...
    let isData = ref(true)
    const toRefStrHtml = toRef(props, "mysqlData")
    watch(toRefStrHtml, () => {
    ...
    let getData= (datalist) => {
        ...
        let Echarts =  echarts.init(document.getElementById('mysqlChart'))
        // 绘制图表
