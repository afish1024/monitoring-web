<template>
    <div id="utilizationoutflowPie"></div>
</template>
<script setup name="utilizationoutflowPie">
    ...
    const portName = ref([])
    let getData= () => {
		return flowApi.outflowUtilizationRate().then((data) => {
            seriesData.value = data.inflowUsage
    ...
    let chartTop = () => {
        let Echarts = echarts.init(document.getElementById('utilizationoutflowPie'))
		
        let yData = seriesData.value;
        const option = {
