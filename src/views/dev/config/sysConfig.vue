<template>
	<a-spin :spinning="loadSpinning">
		<a-form ref="formRef" :model="formData" :rules="formRules" layout="vertical" :label-col="labelCol">
			...
			<a-row :gutter="16">
				<a-col :span="8">
					<a-form-item label="接口执行间隔时间：" name="SNOWY_SYS_VERSION">
						<a-input v-model:value="formData.SNOWY_SYS_VERSION" placeholder="请输入接口执行间隔时间" type="number" :min="1"/>
					</a-form-item>
				</a-col>
				<a-col :span="2" style="line-height: 6;">秒</a-col>
			</a-row>
			<a-row :gutter="16">
				<!-- <a-col :span="8">
			...
			<a-row :gutter="16">
				<a-col :span="8">
					<a-form-item label="接口连接时间：" name="SNOWY_SYS_CONNECT_TIME_OUT">
						<a-input v-model:value="formData.SNOWY_SYS_CONNECT_TIME_OUT" placeholder="请输入接口连接时间" type="number" />
					</a-form-item>
				</a-col>
				<a-col :span="2" style="line-height: 6;">秒</a-col>
			</a-row>
			<a-row :gutter="16">
				<a-col :span="8">
					<a-form-item label="接口响应时间：" name="SNOWY_SYS_TIME_OUT">
						<a-input v-model:value="formData.SNOWY_SYS_TIME_OUT" placeholder="请输入接口响应时间" type="number" />
					</a-form-item>
				</a-col>
				<a-col :span="2" style="line-height: 6;">秒</a-col>
			</a-row>
			<a-row :gutter="16">
				<a-col :span="8">
					<a-form-item label="报警试错次数：" name="SNOWY_SYS_ALARMS_COUNT">
						<a-input v-model:value="formData.SNOWY_SYS_ALARMS_COUNT" placeholder="请输入报警试错次数" type="number" />
					</a-form-item>
				</a-col>
				<a-col :span="2" style="line-height: 6;">次</a-col> 
			</a-row>
			<a-row :gutter="16">
				<a-col :span="8">
					<a-form-item label="报警试错间隔时间：" name="SNOWY_SYS_ALARMS_TIME_INTERVAL">
						<a-input v-model:value="formData.SNOWY_SYS_ALARMS_TIME_INTERVAL" placeholder="请输入报警试错间隔时间" type="number" />
					</a-form-item>
				</a-col>
				<a-col :span="2" style="line-height: 6;">秒</a-col>
			</a-row>
			<a-row :gutter="16">
				<a-col :span="8">
					<a-form-item label="资源采集间隔时间：" name="SNOWY_SYS_RESOURCE_TIME">
						<a-input v-model:value="formData.SNOWY_SYS_RESOURCE_TIME" placeholder="请输入资源采集间隔时间" type="number" />
					</a-form-item>
				</a-col>
				<a-col :span="2" style="line-height: 6;">秒</a-col>
			</a-row>
...
<script setup name="sysConfig">
	...
	const formRules = {
		...
		SNOWY_SYS_VERSION: [required('请输入接口执行间隔时间')],
		...
		SNOWY_SYS_CONNECT_TIME_OUT:[required('请输入接口连接时间')],
		SNOWY_SYS_ALARMS_COUNT:[required('请输入报警试错次数')],
		SNOWY_SYS_TIME_OUT:[required('请输入接口响应时间')],
		SNOWY_SYS_ALARMS_TIME_INTERVAL:[required('请输入报警试错间隔时间')],
		SNOWY_SYS_RESOURCE_TIME:[required('请输入资源采集间隔时间')]
	}
	// 表单固定label实现
	const labelCol = ref({
		style: {
